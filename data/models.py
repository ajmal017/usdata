...
class General(models.Model):
    ...
    sec_type = models.CharField(max_length=250, blank=True, null=True)
    ...
    currency_name = models.CharField(max_length=250, blank=True, null=True)
    currency_symbol = models.CharField(max_length=250, blank=True, null=True)
    country_name = models.CharField(max_length=250, blank=True, null=True)
    country_iso = models.CharField(max_length=250, blank=True, null=True)
    isin = models.CharField(max_length=250, blank=True, null=True)
    cusip = models.CharField(max_length=250, blank=True, null=True)
    cik = models.CharField(max_length=250, blank=True, null=True)
    employer_id_number = models.CharField(max_length=250, blank=True, null=True)
    fiscal_year_end = models.CharField(max_length=250, blank=True, null=True)
    ipo_date = models.CharField(max_length=250, blank=True, null=True)
    international_domestic = models.CharField(max_length=250, blank=True, null=True)
    sector = models.CharField(max_length=250, blank=True, null=True)
    industry = models.CharField(max_length=250, blank=True, null=True)
    gic_sector = models.CharField(max_length=250, blank=True, null=True)
    gic_group = models.CharField(max_length=250, blank=True, null=True)
    gic_industry = models.CharField(max_length=250, blank=True, null=True)
    gic_subindustry = models.CharField(max_length=250, blank=True, null=True)
    home_category = models.CharField(max_length=250, blank=True, null=True)
